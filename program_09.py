...
def ReadData( fileName ):
    ...
    ReplacedValuesDF = pd.DataFrame(0, index=["1. No Data","2. Gross Error","3. Swapped","4. Range"], columns=colNames[1:]) #added additional indexed rows to make adding the values later easier
